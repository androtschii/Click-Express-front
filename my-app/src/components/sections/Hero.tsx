...
export const Hero: React.FC<HeroProps> = ({ onViewLoads, onQuoteClick, onCareersClick }) => {
  ...
  return (
    <section style={{ minHeight: "100vh", marginTop: -70, paddingTop: 70, position: "relative", overflow: "hidden", display: "flex", alignItems: "center", background: isDark ? '#0a0a0a' : '#f4f4f4' }}>
      <style>{`
