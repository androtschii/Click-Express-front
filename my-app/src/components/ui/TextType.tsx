import { useEffect, useRef, useState, useMemo, useCallback, type ElementType, type CSSProperties } from "react";
...
export const TextType: React.FC<TextTypeProps> = ({
  ...
  return (
    <Component ref={setRef} className={`text-type ${className}`} style={style} {...props}>
