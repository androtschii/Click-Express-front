...
export const LOADS: Load[] = [
  ...
  // ── Новые маршруты с Instagram ─────────────────────────────────────────
  { id:9, route:"Lake Ozark, MO", dest:"Newport, AL", price:4000, miles:447, type:"Full Load", cargo:"Flatbed / Heavy Equipment", image:"https://images.unsplash.com/photo-1601584115197-04ecc0da31d7?w=700&q=80", tag:"Best Load of the Week" },
  { id:10, route:"Houston, TX", dest:"Oklahoma City, OK", price:14900, miles:2100, type:"Full Load", cargo:"Flatbed / Multi-Stop", image:"https://images.unsplash.com/photo-1519003722824-194d4455a60c?w=700&q=80", tag:"Best Load of the Week" },
  { id:11, route:"Miami, FL", dest:"Chicago, IL", price:6200, miles:1380, type:"Full Load", cargo:"Flatbed / Oversized", image:"https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=700&q=80", tag:null },
  { id:12, route:"Woodward, OK", dest:"Camden, NJ", price:3800, miles:1320, type:"Full Load", cargo:"Flatbed / Steel Beams", image:"https://images.unsplash.com/photo-1544620347-c4fd4a3d5957?w=700&q=80", tag:"Best Load of the Week" },
];
